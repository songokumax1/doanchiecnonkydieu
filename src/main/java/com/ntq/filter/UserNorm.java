 ...
 * @author songo
 */
@WebFilter(urlPatterns = {"/faces/player.xhtml","/faces/profileuser.xhtml"})
public class UserNorm implements Filter{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (u == null){
                String home = "/faces/login.xhtml?faces-redirect=true";
